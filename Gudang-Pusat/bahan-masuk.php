                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Bahan <span class="table-project-n">Masuk Harian</span> // <?php echo $tanggal; ?><span class="bread-slash"></span></h1><br>
                                    ...
                                    <br>
                                    <a class="btn  btn-primary" href="#" data-toggle="modal" data-target="#DangerModalalert">Tambah Bahan Masuk</a>
                                        ...
                                        <tbody>
                                            ...
                                            while ($show = mysqli_fetch_array($query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-sm btn-primary" href="edit-bahan-masuk.php?id_gudang=<?php echo $idGudang; ?>&id_bahan_masuk=<?php echo $show['ID_BAHAN_MASUK'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> &nbsp;
