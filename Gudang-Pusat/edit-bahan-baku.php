                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="namaBahan" type="text" class="form-control" value="<?php echo $show['NAMA_BAHAN']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="satuan">Satuan</label>
                                                                        <input name="satuan" type="text" class="form-control" value="<?php echo $show['SATUAN']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="biayaTambahan" type="text" class="form-control" value="<?php echo $show['BIAYA_TAMBAHAN']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="margin">Margin</label>
                                                                        <input name="margin" type="text" class="form-control" value="<?php echo $show['MARGIN']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="hargaJual">Harga Jual</label>
                                                                        <input name="hargaJual" type="text" class="form-control" value="<?php echo $show['HARGA_JUAL']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="form-group">
                                                                        <label for="stokAwal">Stok Awal</label>
                                                                        <input name="stokAwal" type="text" class="form-control" value="<?php echo $show['STOK_AWAL']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="barangMasuk">Barang Masuk</label>
                                                                        <input name="barangMasuk" type="text" class="form-control" value="<?php echo $show['BARANG_MASUK']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="barangRusak">Barang Rusak</label>
                                                                        <input name="barangRusak" type="text" class="form-control" value="<?php echo $show['BARANG_RUSAK']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="barangKeluar">Barang Keluar</label>
                                                                        <input name="barangKeluar" type="text" class="form-control" value="<?php echo $show['BARANG_KELUAR']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="sisaStok">Sisa Stok</label>
                                                                        <input name="sisaStok" type="text" class="form-control" value="<?php echo $show['SISA_STOK']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="nilai">Nilai</label>
                                                                        <input name="nilai" type="text" class="form-control" value="<?php echo $show['NILAI']; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
