...
$query = mysqli_query($mysqli, "SELECT  bb.NAMA_BAHAN,\n"
    . "	SUM( IF( MONTH(fk.TANGGAL) = 1, fk.QTY, 0) ) AS januari,\n"
    . "	SUM( IF( MONTH(fk.TANGGAL) = 2, fk.QTY, 0) ) AS februari,\n"
    . "	SUM( IF( MONTH(fk.TANGGAL) = 3, fk.QTY, 0) ) AS maret,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 4, fk.QTY, 0) ) AS april,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 5, fk.QTY, 0) ) AS mei,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 6, fk.QTY, 0) ) AS juni,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 7, fk.QTY, 0) ) AS juli,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 8, fk.QTY, 0) ) AS agustus,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 9, fk.QTY, 0) ) AS september,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 10, fk.QTY, 0) ) AS oktober,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 11, fk.QTY, 0) ) AS november,\n"
    . " SUM( IF( MONTH(fk.TANGGAL) = 12, fk.QTY, 0) ) AS desember,\n"
    . "	SUM( QTY) AS total\n"
    . "FROM faktur as fk \n"
    . "JOIN bahan_baku as bb\n"
    . "ON fk.ID_BAHAN_BAKU = bb.ID_BAHAN_BAKU\n"
    . "JOIN mitra as mt\n"
    . "ON fk.ID_MITRA = mt.ID_MITRA\n"
    . "JOIN gudang as gd\n"
    . "ON mt.ID_GUDANG = gd.ID_GUDANG\n"
    . "WHERE gd.ID_GUDANG = ".$idGudang." GROUP BY bb.NAMA_BAHAN ORDER BY bb.ID_BAHAN_BAKU ASC") or die("data salah: " . mysqli_error($mysqli));
...
<head>
    ...
    <title>Bahan Keluar Perbulan | Tokkebi</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Bahan <span class="table-project-n">Keluar Bulanan</span><span class="bread-slash"></span></h1><br>
