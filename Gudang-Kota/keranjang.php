...
$queryKeranjang = mysqli_query($mysqli, "SELECT bb.*, kr.* FROM BAHAN_BAKU as bb INNER JOIN KERANJANG as kr ON bb.ID_BAHAN_BAKU = kr.ID_BAHAN_BAKU WHERE kr.ID_MITRA='$idMitra'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Keranjang</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1><span class="table-project-n">Keranjang</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <a class="btn btn-sm btn-primary" href="kirim-keranjang.php?<?php echo "id_mitra=" . $idMitra; ?>"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> KIRIM</a>
                                        ...
                                        <tbody>
                                            ...
                                            while ($show = mysqli_fetch_array($queryKeranjang)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-sm btn-danger" title="Delete" href="delete-keranjang.php?<?php echo "id_mitra=" . $idMitra . "&id_keranjang=" . $show['ID_KERANJANG']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><b> Rp. <?php echo $totalSemua;  ?></b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
