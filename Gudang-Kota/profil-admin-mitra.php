...
$queryAdmin = mysqli_query($mysqli, "SELECT * FROM admin_mitra as A join mitra as M ON A.ID_MITRA = M.ID_MITRA where A.USERNAME = '$username';") or die("data salah: " . mysqli_error($mysqli));
...
while ($show = mysqli_fetch_array($queryAdmin)) {
    $nama_admin = $show['NAMA_ADMIN_MITRA'];
    $username = $show['USERNAME'];
    $email = $show['EMAIL'];
    $telp = $show['TELP'];
    $nama_mitra = $show['NAMA_MITRA'];
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Name</b><br /><?php echo $nama_admin ?></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr ">
                                            <p><b>Username</b><br /><?php echo $username ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Phone</b><br /><?php echo $telp ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="address-hr">
                                            <p><b>Mitra</b><br /> <?php echo $nama_mitra ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
