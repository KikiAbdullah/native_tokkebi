...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2020 at 01:56 PM
...
(1, 1, 'Sosis Besar', 'kg', 59000, 1000, 2000, 59000, '121', '121', '0', '120', '1', 7139000),
(2, 1, 'Sosis Kecil', 'kg', 29500, 1000, 1500, 29500, '65', '73', '0', '128', '-55', 1917500),
...
(8, 1, 'Tepung Jadi', 'Kg', 18000, 750, 8050, 26800, '125', '0', '0', '58', '58', 1044000),
...
INSERT INTO `bahan_masuk` (`ID_BAHAN_MASUK`, `ID_BAHAN_BAKU`, `ID_GUDANG`, `TANGGAL`, `JUMLAH`) VALUES
(31, 4, 1, '2020-03-12', 12),
(32, 5, 1, '2020-03-12', 2),
(33, 2, 1, '2020-03-15', 1),
(34, 10, 1, '2020-03-15', 12);
...
INSERT INTO `bahan_rusak` (`ID_BAHAN_RUSAK`, `ID_BAHAN_BAKU`, `ID_GUDANG`, `TANGGAL`, `JUMLAH`) VALUES
(1, 18, 1, '2020-03-15', 10);
...
(16, 0, 1, 5, 1, 112000.00, '2020-03-10', 'inventory.png', '21:51:47', '21:51:52', '21:54:09', 'Diproses');
...
ALTER TABLE `mitra`
  ...
  ADD KEY `FK_MITRA_MEMILIKI_GUDANG` (`ID_GUDANG`);
...
--
ALTER TABLE `bahan_masuk`
  MODIFY `ID_BAHAN_MASUK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `admin_mitra`
  ADD CONSTRAINT `FK_ADMIN_OU_MENGURUS_MITRA` FOREIGN KEY (`ID_MITRA`) REFERENCES `mitra` (`ID_MITRA`);

--
-- Constraints for table `bahan_baku`
--
ALTER TABLE `bahan_baku`
  ADD CONSTRAINT `FK_BAHAN_BA_DIMILIKI_GUDANG` FOREIGN KEY (`ID_GUDANG`) REFERENCES `gudang` (`ID_GUDANG`);

--
-- Constraints for table `faktur`
--
ALTER TABLE `faktur`
  ADD CONSTRAINT `FK_FAKTUR_BERTANGGU_ADMIN_PU` FOREIGN KEY (`ID_ADMIN_PUSAT`) REFERENCES `admin_pusat` (`ID_ADMIN_PUSAT`),
  ADD CONSTRAINT `FK_FAKTUR_DIMILIKI__MITRA` FOREIGN KEY (`ID_MITRA`) REFERENCES `mitra` (`ID_MITRA`);

--
-- Constraints for table `gudang`
--
ALTER TABLE `gudang`
  ADD CONSTRAINT `FK_GUDANG_DIKELOLA_ADMIN_PU` FOREIGN KEY (`ID_ADMIN_PUSAT`) REFERENCES `admin_pusat` (`ID_ADMIN_PUSAT`);

--
-- Constraints for table `keranjang`
--
ALTER TABLE `keranjang`
  ADD CONSTRAINT `FK_KERANJAN_DIMILIKI__MITRA` FOREIGN KEY (`ID_MITRA`) REFERENCES `mitra` (`ID_MITRA`);

--
-- Constraints for table `mitra`
--
ALTER TABLE `mitra`
  ADD CONSTRAINT `FK_MITRA_MEMILIKI_GUDANG` FOREIGN KEY (`ID_GUDANG`) REFERENCES `gudang` (`ID_GUDANG`);
COMMIT;
